...
<div class="container">
  <div class="row">
    <div class="col-md-10 ">
      <form method="post" action="modifier_profile.php" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input id="Nom" name="nom" type="text" placeholder="Nom de l'entreprise" value="<?php echo $entreprise["nom"]; ?>" class="form-control input-md">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-thumbs-up"></span> Enregistrer</button>
