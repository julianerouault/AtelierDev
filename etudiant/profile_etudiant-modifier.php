...
<div class="container">
  <div class="row">
    <div class="col-md-10 ">
      <form class="form-horizontal" action="modifier_etudiant.php" method="post">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input id="Nom" name="nom" type="text" placeholder="Nom" value="<?php echo $etudiant["nom"]; ?>" class="form-control input-md">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input id="Prénom" name="prenom" type="text" placeholder="Prénom" class="form-control input-md">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <div class="input-group">
                ...
                <input id="Naissance" name="date_naissance" type="date" placeholder="Date de naissance" class="form-control input-md">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input id="Téléphone" name="telephone" type="text" placeholder="Numéro de fixe" class="form-control input-md">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input id="niveau étude" name="niveau" type="text" placeholder="Niveau d'étude actuel" class="form-control input-md">
              </div>
